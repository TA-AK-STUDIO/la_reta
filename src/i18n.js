...
export const i18n = {
  es: {
    ...
    tutorial_6_wind_body:  'Ráfagas aparecen cada cierto tiempo.\nDesvían el balón horizontalmente.\nLas flechas en pantalla indican la dirección.',
  ...
  en: {
    ...
    tutorial_6_wind_body:  'Gusts appear every so often.\nThey push the ball horizontally.\nArrows on screen show the direction.',
